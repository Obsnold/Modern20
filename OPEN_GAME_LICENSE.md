...
The Modern20 system distributes Open Game Content from the d20 Modern System
Reference Document under the Open Game License v1.0a, reproduced in full below.

Product Identity is not included: no Wizards of the Coast trademarks, logos,
trade dress, or the "d20 System" mark are used or licensed here. The system's
own source code is licensed separately; see LICENSE.md.

The text below is reproduced from the SRD's legal page at
https://spellbooksoftware.com/d20mrsd/legal.html
...
Modern20 for Foundry Virtual Tabletop Copyright 2026, Terry.
