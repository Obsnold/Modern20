...
"""Generate the figures the in-world self-test checks against.
    ...
    python3 scripts/gen_selftest.py            # write module/selftest-data.mjs
    python3 scripts/gen_selftest.py --check    # fail if it is out of date
    ...
    if arguments.check:
        ...
        if current != rendered:
            print("FAIL  module/selftest-data.mjs is out of date — "
                  "run python3 scripts/gen_selftest.py")
            return 1
