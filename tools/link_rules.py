...
edited.
    ...
    python3 tools/link_rules.py             # stamp what is missing or stale
    python3 tools/link_rules.py --dry-run   # say what would change
    python3 tools/link_rules.py --report    # list the documents with no page
