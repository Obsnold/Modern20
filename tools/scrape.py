...
"""Read the d20 Modern SRD into normalized JSON under data/.
    ...
    python3 tools/scrape.py            # parse from .cache/, fetching what is missing
    python3 tools/scrape.py --refresh  # re-fetch every page first

Output is committed. A schema change means re-running tools/build_packs.py,
